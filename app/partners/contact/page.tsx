...
export async function generateMetadata({ searchParams }: PartnersContactPageProps): Promise<Metadata> {
...
export default async function PartnersContactPage({ searchParams }: PartnersContactPageProps) {
  const params = searchParams ? await searchParams : {};
