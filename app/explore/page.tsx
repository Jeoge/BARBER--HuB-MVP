import { Briefcase, GraduationCap, MessageSquare, Search, ShieldCheck, Sparkles, Wrench } from "lucide-react";
...
export default function ExplorePage() {
  return (
    <PageChrome>
      ...
      <section className="px-4 pt-5">
        <AuthGateLink kind="backyard" className="flex w-full items-center gap-3 rounded-[8px] border border-blush/20 bg-blushSoft p-4 text-left">
