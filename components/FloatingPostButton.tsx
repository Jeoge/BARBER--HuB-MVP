...
import { BriefcaseBusiness, Building2, Camera, FilePenLine, FileText, MessageSquare, Plus, ShieldCheck, Video, X } from "lucide-react";
...
const postItems = [
  ...
  { label: "開業・承継を掲載", icon: Building2, href: "/post/succession", kind: "succession" as const, signupNextHref: "/post/succession" },
