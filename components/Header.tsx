  ...
  if (variant === "home") {
    return (
      <header className="sticky top-0 z-40 overflow-hidden border-b border-white/10 bg-[#050505] text-white">
        <div className="relative mx-auto flex min-h-[calc(8.75rem+env(safe-area-inset-top))] max-w-[430px] items-center justify-center overflow-hidden px-4 pb-4 pt-[calc(env(safe-area-inset-top)+1rem)]">
          <div
            aria-hidden="true"
