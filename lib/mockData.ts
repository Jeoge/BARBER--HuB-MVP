...
export const articles: Article[] = [
  ...
  {
    id: "tools-silent-clipper",
    profileId: "sample-maker-clipper",
    title: "静音バリカンを朝イチ施術で使うなら",
    category: "道具",
    topicSlugs: ["tools", "technique"],
    author: "BARBER HUB編集部",
    date: "2026.07.04",
    summary: "朝イチのお客様や静かな店内で気になるバリカン音。静音性、重さ、刈り心地、充電、替刃の見やすさを整理します。",
    body: [
      "朝イチの施術では、店内の音がいつもより目立ちます。バリカンの駆動音や振動は、お客様の緊張感にも関わるため、静音性は選び方の大事な軸になります。",
      "確認したいのは、音だけではありません。重さ、手元の安定感、刈り心地、充電の持ち、替刃の見やすさまで含めて、営業の流れに合うかを見ます。",
      "静かな空間づくりを大切にするサロン、子どもカットが多いサロン、朝イチ施術の満足度を上げたいサロンでは、導入前にメーカー講習や地域ディーラーへ相談すると選びやすくなります。",
    ],
    thanks: 0,
    comments: 8,
    accent: "tool",
  ...
  {
    id: "tools-fade-comb",
    profileId: "sample-dealer-national",
    title: "フェードで使いやすいコームの選び方",
    category: "道具",
    topicSlugs: ["tools", "technique"],
    author: "BARBER HUB編集部",
    date: "2026.07.04",
    summary: "コームの硬さ、長さ、色、歯の細かさ。フェードや刈り上げで見やすい道具の選び方。",
    body: [
      "フェードで使うコームは、硬さと長さで手元の安定感が変わります。柔らかすぎると角度がぶれやすく、硬すぎると頭の丸みに沿わせにくいことがあります。",
      "色も大切です。髪色や店内照明によって境目の見え方が変わるため、白、黒、明るめの色を使い分けると確認しやすくなります。",
      "バリカンとの相性、歯の細かさ、持ち替えやすさは、現場のSnapとも相性がよいテーマです。気になる場合は、メーカーやディーラーの比較相談を使うと選びやすくなります。",
    ],
    thanks: 0,
    comments: 6,
    accent: "haircut",
  ...
  {
    id: "tools-blade-maintenance",
    profileId: "sample-dealer-kyushu",
    title: "替刃の交換タイミング、どう見ていますか？",
    category: "道具",
    topicSlugs: ["tools", "technique"],
    author: "BARBER HUB編集部",
    date: "2026.07.04",
    summary: "切れ味が落ちるサイン、肌あたり、音、引っかかり。替刃とメンテナンス用品の見直しメモ。",
    body: [
      "替刃の交換タイミングは、切れ味だけでなく、お客様の肌あたりにも出ます。音が変わる、引っかかる、同じ場所を何度も通るようになったら見直しの合図です。",
      "メンテナンス用品を使っていても、営業量や毛量、使う技術によって交換時期は変わります。数字だけでなく、仕上がりの差を見て判断します。",
      "地域ディーラーは、替刃の状態や使い方を現場目線で相談しやすい相手です。導入前だけでなく、使い続ける中での相談先としても価値があります。",
    ],
    thanks: 0,
    comments: 5,
    accent: "tool",
  ...
  {
    id: "tools-opening-checklist",
    profileId: "sample-dealer-kyushu",
    title: "開業前に揃えたい道具チェック",
    category: "開業準備",
    topicSlugs: ["tools", "management"],
    author: "BARBER HUB編集部",
    date: "2026.07.04",
    summary: "バリカン、トリマー、シザー、コーム、クロス、タオル、消毒用品、店販まで。開業前の道具整理。",
    body: [
      "開業前は、バリカン、トリマー、シザー、コーム、クロス、タオル、消毒用品、店販まで、必要な道具が一気に増えます。",
      "大切なのは、最初から全部を最高級で揃えることではなく、営業導線とメニューに合う優先順位を決めることです。毎日使うもの、替えが必要なもの、後から足せるものに分けて考えます。",
      "地域ディーラーやメーカー相談は、地域のサロン事情や講習会情報も含めて聞けるのが強みです。開業準備では、価格だけでなく相談できる相手も選び方の一部になります。",
    ],
    thanks: 0,
    comments: 7,
    accent: "student",
  ...
  {
    id: "tools-styling-products",
    profileId: "sample-maker-clipper",
    title: "メンズ店販で使いやすい整髪料の見せ方",
    category: "店販",
    topicSlugs: ["tools", "marketing"],
    author: "BARBER HUB編集部",
    date: "2026.07.04",
    summary: "店販を押し売りにしない見せ方。お客様が選びやすい説明と、メーカー資料・ディーラー提案への導線。",
    body: [
      "整髪料の店販は、押し売りではなく、お客様が家でも再現しやすくなるための説明として置くと自然です。",
      "ワックス、グリース、ジェルの違いを短く伝え、仕上げで使ったものを見える場所に置くと、会話のきっかけになります。",
      "メーカー資料やディーラー提案は、商品の特徴を短く整理する助けになります。Snapや記事で使い方を見せ、商品認知へ自然につなげるのがBARBER HUBらしい導線です。",
    ],
    thanks: 0,
    comments: 4,
    accent: "news",
...
export const news: NewsItem[] = [
  ...
  {
    id: "grooming-fragrance-summer",
    title: "夏の身だしなみ、香りは控えめに",
    summary: "香水や整髪料の香りは、暑い時期ほど距離感が大切です。",
    body: "夏場は汗や湿気で香りの感じ方が強くなることがあります。香水、整髪料、シャンプーの香りは、清潔感の提案として短く話すと自然です。強さを決めつけず、お客様の好みを聞く入口にできます。",
    conversationTip: "夏は香りが少し強く感じやすいので、軽めに整える方も増えています。",
    morningTip: "仕上げの香りや整髪料は、押しつけず好みを聞きながら提案しましょう。",
    category: "身だしなみ",
    time: "07:40",
  },
  {
    id: "music-bgm-smalltalk",
    title: "店内BGM、今日は少しだけ軽く",
    summary: "音楽の話題は、好みを聞きながら自然に広げやすい会話です。",
    body: "店内BGMは、店の空気づくりにもお客様との会話にもつながります。流行曲を追いすぎる必要はありませんが、季節や時間帯に合う音量と雰囲気を意識すると、施術中の居心地を整えやすくなります。商用利用条件は各サービスの公式情報を確認してください。",
    conversationTip: "最近、店では少し軽めの音にしています。普段どんな音楽を聴きますか？",
    morningTip: "BGMは音量と雰囲気を確認し、会話の邪魔にならない状態から始めましょう。",
    category: "会話ネタ",
    time: "07:45",
  },
  {
...
const relatedProductMap: Record<string, string[]> = {
  ...
  "tools-silent-clipper": ["quiet-clipper-pro", "fade-brush-comb-set"],
  "tools-fade-comb": ["fade-brush-comb-set", "quiet-clipper-pro"],
  "tools-blade-maintenance": ["quiet-clipper-pro", "fade-brush-comb-set"],
  "tools-opening-checklist": ["quiet-clipper-pro", "fade-brush-comb-set", "review-request-card"],
  "tools-styling-products": ["review-request-card", "scalp-care-starter"],
