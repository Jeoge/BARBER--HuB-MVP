...
export const jobListings: JobListing[] = [
  {
    ...
    benefits: ["雇用保険", "労災保険", "交通費相談", "営業後レッスン"],
    tags: ["メンズ特化", "フェード", "顔剃りあり", "教育あり", "駅近", "少人数サロン"],
    description:
      "地域の男性客に支持されるメンズ特化サロンです。フェードや顔剃りを丁寧に学びながら、落ち着いた接客を身につけられます。",
  ...
  },
  {
    ...
    description:
      "ビジネスマン向けのカット、白髪ぼかし、シェービング提案が多いサロンです。落ち着いた接客と提案力を磨きたい方に向いています。",
  ...
  },
  {
    ...
    description:
      "フェード、ショート、バーバースタイルの入客が多いサロンです。営業後の練習会で基礎から確認できます。",
  ...
  },
  {
    ...
    description: "シェービングとヘッドスパリピートが多い、落ち着いた雰囲気のサロンです。",
